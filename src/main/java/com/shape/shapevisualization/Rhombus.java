...
public class Rhombus extends JPanel implements Object {
    ...
    protected void paintComponent(Graphics g) {
        ...
        int[] xPoints = {centerX, centerX + sideLength, centerX, centerX - sideLength};
        int[] yPoints = {centerY - sideLength, centerY, centerY + sideLength, centerY};

        g.setColor(shadowColor);
        int[] xShadowPoints = {centerX + shadowOffsetX, centerX + sideLength + shadowOffsetX, centerX + shadowOffsetX, centerX - sideLength + shadowOffsetX};
        int[] yShadowPoints = {centerY - sideLength + shadowOffsetY, centerY + shadowOffsetY, centerY + sideLength + shadowOffsetY, centerY + shadowOffsetY};
    ...
    @Override
    public void draw() {
        JFrame frame = new JFrame("Rhombus Drawing Example");
