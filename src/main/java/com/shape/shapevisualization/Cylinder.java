...
public class Cylinder extends JPanel implements Object {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.fillOval(x + shadowOffsetX, y + shadowOffsetY, diameter, height);
        g2d.fillRect(x + shadowOffsetX, y + shadowOffsetY, diameter, height);

        g2d.setColor(fillColor);
        g2d.fillOval(x, y, diameter, height);
        g2d.fillRect(x, y, diameter, height);

        g2d.setColor(Color.BLACK);
        g2d.drawOval(x, y, diameter, height);
        g2d.drawLine(x, centerY - height / 2, x, centerY + height / 2);
        g2d.drawLine(x + diameter, centerY - height / 2, x + diameter, centerY + height / 2);

        // Draw the cylinder top and bottom circles
        g2d.setColor(shadowColor);
    ...
    @Override
    public void draw() {
        JFrame frame = new JFrame("Cylinder Drawing Example");
